...
%          /Users/realgjl/OneDrive - University of Leeds/Nordic/g8/data/temp_display_0.00-0.00-0.01s.cur
% 
...
xlsxFolder = '/Users/realgjl/OneDrive - University of Leeds/Nordic/g8/analysis';
...
for delay = 0.2
    ...
    for kp = 0.1:1.0:50.1
        for ki = 0.1:1.0:15.1
            s = [curFolder, ...
                '/temp_display_', breaker, '_', num2str(kp,'%.2f'), '-', num2str(ki,'%.2f'), '-', num2str(delay,'%.1f'), 's', '.cur'];
            s
            a = importdata(s);
            t = a(:,1);
            f = a(:,4);
